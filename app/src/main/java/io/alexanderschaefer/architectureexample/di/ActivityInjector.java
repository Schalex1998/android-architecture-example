...
import io.alexanderschaefer.architectureexample.base.ArchitectureExampleApplication;
import io.alexanderschaefer.architectureexample.base.BaseActivity;
...
public class ActivityInjector {
    ...
    static ActivityInjector get(Context context) {
        return ((ArchitectureExampleApplication) context.getApplicationContext()).getActivityInjector();
    }
}
